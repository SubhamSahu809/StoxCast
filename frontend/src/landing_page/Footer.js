...
function Footer() {
  return (
    <footer style={{background:"#eee", borderTop:"1px solid #ccc", fontSize:"0.8rem"}} >
        <div className="container ms-5">
            <div className="footer row ms-3 p-5">
                <div className="col">
            ...
            <div className="row" style={{ fontSize: "0.8rem", padding: "0 5rem" }}>
                <p>
