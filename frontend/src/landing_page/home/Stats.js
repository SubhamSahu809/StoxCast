        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-5 p-5'>
                    ...
                    <p className='text-muted mb-5'>That's why 1.5+ crore customers trust Zerodha with ₹4.5+ lakh crores of equity investments and contribute to 15% of daily retail exchange volumes in India.</p>
                ...
                <div className='col-7'>
                    <img src='media/ecosystem.png' style={{width: "90%"}} className='mt-5'/>
                    <div className='ms-5'>
